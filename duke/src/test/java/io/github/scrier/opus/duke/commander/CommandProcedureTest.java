...
public class CommandProcedureTest {
  ...
  @Before
	...
	public void testProcedure() {
		CommandProcedure testObject = new CommandProcedure(component, "this is command", CommandState.EXECUTE);
		...
		assertEquals(component, check.getComponent());
	}
	
	@Test
	public void testProcedure2() {
		CommandProcedure testObject = new CommandProcedure(component, "this is another command", CommandState.QUERY, true);
		assertEquals(testObject.CREATED, testObject.getState());
		assertEquals(identity, testObject.getIdentity());
		assertEquals(1, testObject.getTxID());
		NukeCommand check = testObject.getNukeCommand();
